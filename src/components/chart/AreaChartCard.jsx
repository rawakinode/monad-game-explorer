                ...
                <div className="flex gap-2">
                    {["7d", "30d", "all"].map(r => (
                        <button
                            key={r}
                            onClick={() => setRange(r)}
                            className={`px-3 py-1 rounded text-sm ${range === r ? "bg-background text-primary" : "bg-muted text-muted-foreground"
                                }`}
                        >
                        ...
                        >
                            ...
                            <ChartTooltip
                                ...
                                content={({ active, payload, label }) => {
                                    ...
                                    return (
                                        <div className="rounded bg-black px-3 py-2 text-white text-xs shadow">
                                            <div>{label}</div>
                                            <div>
